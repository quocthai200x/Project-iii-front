<template >
    <div>
        <div v-for="(application, index) in applicationList" :key="'job-apply-' + index">
            <div v-if="application.status.value == notQualifyValue || application.status.value == rejectByUserValue">
                <div class="row q-gutter-md">
                    ...
                    <div class="col-7">
                        ...
                        <div class="text-negative" v-if="application.status.value == notQualifyValue">
                            <i>Doanh nghiệp từ chối</i>
                            <q-icon class="q-ml-xs" name="check_circle"></q-icon>
                        </div>
                        <div class="text-negative" v-if="application.status.value == rejectByUserValue">
                            <i>Ứng viên từ chối</i>
                        </div>
                    </div>
                    <div class="col-2 col">
...
export default {
    ...
    data() {
        return {
            $q: useQuasar(),
            rejectByUserValue: applicationDictionary.status.rejectByUser.value,
            notQualifyValue: applicationDictionary.status.notQualify.value,
            indexComment: null,
            comment: null,
            rating: 1,
            prompt: false
